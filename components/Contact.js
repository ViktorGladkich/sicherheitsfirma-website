  ...
  return (
    <>
      <section id="contact" className="py-20 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={sectionHeaderRef} className="text-center mb-16 relative">
            ...
            >
              Haben Sie Fragen oder wünschen ein individuelles Angebot? Wir
            ...
            >
              <div className="space-y-6">
                <motion.div variants={formItemVariants}>
                  <label
                    htmlFor="firstName"
                    className="flex items-center text-lg font-medium text-brand-teal mb-1"
                  >
              ...
              <motion.div variants={formItemVariants} className="mt-auto">
                ...
                {!formStatus.isSending && formStatus.message && (
                  <motion.p
                    ...
                    className={`mt-4 text-sm text-center ${formStatus.isError ? "text-red-400" : "text-green-400"}`}
                  >
                    {formStatus.message}
                  </motion.p>
                )}
      ...
      <AnimatePresence>
        {formStatus.isSending && (
          <Preloader
            key="formSendingIndicatorOverlay"
            isSendingForm={true} 
